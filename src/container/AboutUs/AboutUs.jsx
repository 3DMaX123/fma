    ...
    <div className='app__aboutus'>
      <div className='app__aboutus-textdecoratives'>
        <div className='pinksubstrate'>
          ...
          <p className='Review'>Ми команда(ні), що розуміє проблеми бізнесу та їх <br /> виклики сьгодення. Тому і глобальною ціллю <br /> нашої компанії стали: просування сайтів <br /> рекламним та органічним шляхом, організація <br /> роботи рекламних кампаній, їх супровід з <br /> підготовкою сайту до викликів. </p>
